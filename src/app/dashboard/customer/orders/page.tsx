      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {filteredRentals.map((order) => (
            <div
              key={order.id}
              className="space-y-4 w-full rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-blue-500 dark:border-slate-800 dark:bg-slate-900"
            >
                ...
                <div className="border-t border-slate-100 pt-4 dark:border-slate-800/80">
                  <div className="grid grid-cols-4 gap-2 text-center">
                    {[
                      ...
                      const statusOrder = ["PLACED", "CONFIRMED", "PAID", "PICKED_UP", "RETURNED"];
