      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {filteredRentals.map((order) => (
            <div
              key={order.id}
              className="flex flex-col items-start justify-between gap-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-emerald-500 sm:flex-row sm:items-center dark:border-slate-800 dark:bg-slate-900"
            >
